...
- 🧠 **[Vibrisse Agent](https://github.com/QuentinMerle/vibrisse-agent)**: A sovereign engineering partner and local-first agentic framework. Features triple-layer RAG, LangGraph orchestration, MCP-native tool use, and an Obsidian Glass UI. *(Discover it on agent.vibrisse-studio.dev)*
- 🏓 **[Ping Prompt](https://github.com/QuentinMerle/ping-prompt)**: An asymmetric Air Hockey prototype running a local SLM (WebLLM/Phi-3) directly in the browser. The AI profiles you via Brain.js and actively hacks the DOM to cheat when it's losing.
